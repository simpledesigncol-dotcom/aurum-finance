...
export default function Modal({ title, subtitle, onClose, children, wide }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className={`relative bg-card rounded-xl border border-border shadow-[0_20px_60px_rgba(0,0,0,0.12)] w-full ${wide ? 'max-w-lg' : 'max-w-md'} mx-4 max-h-[90vh] overflow-hidden animate-scale-in`}>
